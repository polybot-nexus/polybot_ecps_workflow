...
def tecan_read(filename):
    ...
    file_name = pd.read_csv('polybot_app/demo_files/from_tecan/green_loop_3_new_target.csv')  #(csv_filepath)
    ...
    file_name.to_csv('polybot_app/demo_files/from_tecan/green_loop_3_new_target_scaled.csv', index=None)
    #return csv_filepath

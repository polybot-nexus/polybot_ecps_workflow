...
def iter_run(init_file, iteration):
    ...
    local_path_from_tecan = "C:/Users/kvriz/Desktop/polybot_workcell/polybot_app/demo_files/from_tecan"
    fname_tecan = f"green_loop_3_new_target.csv"  #"ECP_demo_batch_0.asc"# C:\Users\kvriz\Desktop\polybot_workcell\polybot_app\demo_files\from_tecan\ECP-Close-1-20240223.csv
    filename=os.path.join(local_path_from_tecan, fname_tecan)
    
    df = tecan_read(filename)
    lab_values = tecan_proc('polybot_app/demo_files/from_tecan/green_loop_3_new_target_scaled.csv')
    # pd.DataFrame(lab_values, columns=["L", "a", "b"]).to_csv('polybot_app/demo_files/metadata/new_green_loop_1.csv')
...
init_file = 'C:/Users/kvriz/Desktop/polybot_workcell/polybot_app/demo_files/init.json'
...
target_Lab= np.array([65, -10, 30])   #75, 36, 70
# measured_lab_values= [[81.08002999,  30.43879639,  61.30982944]] #81.08002999	30.43879639	61.30982944


# measured_lab_values= [[79.5, 36, 55.43]]-8.844403667	53.19287695

measured_lab_values= [[55, -10, 30 ]]

#[[75.90751966,	34.35987901,	59.49106892]]


# measured_lab_values= [[74.1586179949,37.7997757645,52.1277843317]]
# measured_lab_values= [[57.3126983648,24.75388178,25.5604360853]]
print(get_lab_distance(target_Lab, measured_lab_values))
# 46.85081978	15.38472531	13.86680872


#array([ 68.53336531,  50.38962504,  33.71859909]), array([ 64.69167104,  36.60735072,  33.95854786]), array([ 48.75714238,  17.648057  ,  16.09061998]), array([ 81.65407406,  -0.56628256,  59.24461097]), array([ 57.76318066,  42.31240928,   8.70433662])]
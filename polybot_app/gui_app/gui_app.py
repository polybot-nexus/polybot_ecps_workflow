...
def demo_page(init_file=None):
    ...
    df_random = pd.read_csv('C:/Users/kvriz/Desktop/polybot_workcell/polybot_app/demo_files/ml_electrochromics_database_gui.csv')
    ...
    strings = ['ProDOT-2Br', 'Ben-2Br', 'BTD-2Br', 'DMoT-2Br', 'EDOT-2Br', 'Fl-2Br']
    monomers_dict = {"ProDOT-2Br": "Cc1sc(C)c2OCC(COCC(CC)CCCC)(COCC(CC)CCCC)COc12", 
                     "Ben-2Br":"C1=CC(=CC=C1C)C", "BTD-2Br":"Cc1ccc(C)c2nsnc12", 
                     "DMoT-2Br": "Cc1sc(C)c(OC)c1OC", "EDOT-2Br":"Cc1sc(C)c2OCCOc12", 'Fl-2Br':"Cc1sc(C)c2OCCOc12"}
    # Select monomers
    monomers_list=[]
    for s in strings:
    ...
    if st.button('Send instructions', key =0):
        import json
        with open('C:/Users/kvriz/Desktop/polybot_workcell/polybot_app/demo_files/init.json', 'w', encoding='utf-8') as f:
...
init_file = 'C:/Users/kvriz/Desktop/polybot_workcell/polybot_app/demo_files/init_successful_run.json'
demo_page(init_file)

#C:\Users\kvriz\Desktop\polybot_workcell\polybot_app\demo_files\init_successful_run.json
